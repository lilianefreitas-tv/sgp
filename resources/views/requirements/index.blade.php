                        ...
                        @forelse ($requirements as $requirement)
                            <tr class="text-sm text-[#24313A] {{ $requirement->is_active ? '' : 'bg-[#FAFBFB] opacity-75' }}">
                                <td class="max-w-md px-6 py-4">
                                    <a href="{{ route('projects.requirements.show', [$project, $requirement]) }}" class="font-semibold text-[#228A9D] hover:underline">{{ $requirement->code }} · {{ $requirement->title }}</a>
                                ...
                                <td class="px-6 py-4 text-right">
                                    <a href="{{ route('projects.requirements.show', [$project, $requirement]) }}" class="font-semibold text-[#17A2B8] hover:underline">Visualizar</a>
                                </td>
                            </tr>
                        @empty
                            <tr>
