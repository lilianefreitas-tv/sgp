<section class="rounded-2xl border border-[#DCE3E7] bg-white p-5 shadow-sm sm:p-6">
    <div>
        <p class="text-xs font-bold uppercase tracking-[.18em] text-[#17A2B8]">P04.5 · Engenharia documental adaptativa</p>
