        ...
        <section class="rounded-2xl border border-[#DCE3E7] bg-white p-5 shadow-sm">
            <form method="GET" action="{{ route('platform.security-audit.index') }}" class="grid gap-4 md:grid-cols-[1fr_220px_auto] md:items-end">
                <div>
                    ...
                    <input id="action" name="action" value="{{ $action }}" placeholder="Ex.: password.platform_admin.request" class="mt-1 block w-full rounded-lg border-[#C9D3D9] text-sm focus:border-[#17A2B8] focus:ring-[#17A2B8]">
                </div>
                <div>
