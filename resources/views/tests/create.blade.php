<x-app-layout>
    <x-slot name="header"><div><p class="text-sm font-semibold text-[#17A2B8]">{{ $project->code }}</p><h1 class="mt-1 text-xl font-bold text-[#24313A]">Novo caso de teste</h1></div></x-slot>
