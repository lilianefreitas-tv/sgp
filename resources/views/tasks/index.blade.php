<x-app-layout>
    <x-slot name="header">
        <div class="min-w-0"><p class="text-sm font-semibold text-[#17A2B8]">{{ $project->code }}</p><h1 class="truncate text-xl font-bold text-[#24313A]">Tarefas de {{ $project->name }}</h1><p class="mt-1 text-sm text-[#667680]">Planeje e acompanhe as atividades necessárias para entregar o projeto.</p></div>
    </x-slot>
    <div class="space-y-5">
